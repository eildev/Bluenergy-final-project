...
const ProfessionalCard = ({ data }) => {
  ...
  return (
    <motion.div
      ...
      className="max-w-[300px] p-10 rounded-t-full border-2 bg-white border-secondary place-self-center"
    >
      ...
      <div className="text-center my-5">
        <h4 className="text-secondary font-bold text-2xl mb-2">{name}</h4>
        <p className="">{designation}</p>
      </div>
      <div className="flex justify-center items-center gap-5">
        <a
          href={facebook}
          className="bg-secondary text-white w-9 h-8 flex justify-center items-center rounded"
        >
